      ...
      <main class="editor-workspace">
        <header class="workspace-bar">
          ...
          <div class="workspace-actions">
            <button type="button" :title="inspectorOpen ? 'Hide settings' : 'Show settings'" :aria-label="inspectorOpen ? 'Hide settings' : 'Show settings'" @click="inspectorOpen = !inspectorOpen"><Menu :size="18" /></button>
