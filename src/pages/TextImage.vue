  ...
  <main class="component-library-page">
    <header class="page-header">
      <div>
        ...
        <h1>Text Image Components</h1>
        <p class="page-description">Browse every component on one page. Open the editor only for the component you want to customize.</p>
      </div>
      <span class="component-count">{{ components.length }} components</span>
    </header>

    <section class="component-list" aria-label="Text Image components">
